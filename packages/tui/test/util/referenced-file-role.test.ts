...
describe("referenced file role", () => {
  test.each([
    ...
    ["jsconfig.paths.json", "configuration"],
    [".eslintrc.json", "configuration"],
    [".prettierrc.yaml", "configuration"],
  ...
  test.each([
    ...
    ["tsconfig.app.json", "configuration", "Its filename is a recognized project configuration file."],
    [".eslintrc.json", "configuration", "Its filename is a recognized project configuration file."],
